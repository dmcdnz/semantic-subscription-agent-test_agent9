...
# Basic information
agent:
  name: "Test_agent9 Agent"
  package_name: "test_agent9"
...
python ../../test_framework.py agent test_agent9

# Test classification model
python ../../test_framework.py classifier test_agent9
```
...
docker logs agent-test_agent9-container
```
